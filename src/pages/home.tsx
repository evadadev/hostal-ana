    ...
    return (
        <Layout>
            <div>
                ...
                <article className="bg-slate-50 p-5 text-orange-800">Teniendo WiFi en toda la propiedad, el Hostal Ana - Adults Recommended Nerja, de 2 estrellas, está a menos de 12 minutos a pie de la Playa de Burriana.
